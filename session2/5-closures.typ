...
#slide[
  ...
  Please open demo file `session2/examples/s2e5-closure-traits.rs` and play around with the code.
]
...
#slide[
  ...
  Please find the statement of the exercise at `session2/examples/s2d6-closures.rs` in this repo.
